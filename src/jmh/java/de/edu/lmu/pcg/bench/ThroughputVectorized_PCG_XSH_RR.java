...
@State(Scope.Thread)
public class ThroughputVectorized_PCG_XSH_RR {

    private ByteBuffer buff;
    private Random seed_init;
    private PCG_XSH_RR pcg;
    private PCGBuilder<PCG_XSH_RR, Long>.StateConfigured builder;
    ...
    public void setUpOnce() {
        ...
        buff = ByteBuffer.allocateDirect(256);
        //assume 64 = one cache line
        //assume 32 = 84 long are one lane
        builder = new PCGBuilder<>().preferred_variant(JavaVectoring).type(PCG_XSH_RR.class);
    }
